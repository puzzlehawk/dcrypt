...
//in {
//	assert(output.length == message.length + Poly1305ChaCha20.macSize, "Output buffer too short. Should be message.lenght + Poly1305ChaCha20.macSize.");
//}
//body {
//
//	ubyte[32] s = curve25519_scalarmult(sk, pk); /// shared secret
//
//	Poly1305ChaCha20 cipher;
//	cipher.start(true, s, 0, nonce);
//	cipher.processBytes(message, output);
//	ubyte[Poly1305ChaCha20.macSize] mac;
//	cipher.finish(mac);
//	output[$-Poly1305ChaCha20.macSize..$] = mac;
//
//	wipe(s);
//}
//
...
//in {
//	assert(output.length == ciphertext.length - Poly1305ChaCha20.macSize, "Output buffer too short. Should be message.lenght - Poly1305ChaCha20.macSize.");
//}
//body {
//	
//	ubyte[32] s = curve25519_scalarmult(sk, pk); /// shared secret
...
//	cipher.finish(mac);
//
//	const ubyte[] actualMac = ciphertext[$-Poly1305ChaCha20.macSize..$];
//
...
//	ubyte[] ciphertext = new ubyte[msg.length + Poly1305ChaCha20.macSize];
//
//	// wrap into box
//	crypto_box(ciphertext, msg, n, skA, pkB);
//
//	ubyte[] msg2 = new ubyte[ciphertext.length - Poly1305ChaCha20.macSize];
//
//	try {
//		// unwrap
